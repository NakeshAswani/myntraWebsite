        ...
        <div>
            <main className='main1 w-[100%] '>
                ...
                <div className='py-10 max-w-7xl mx-auto'>
                    ...
                    <div className='mb-5'>
                        <h2 className='text-[14px] font-bold mb-1'>ONLINE SHOPPING MADE EASY AT MYNTRA</h2>
                    ...
                    <div className='mb-5'>
                        <h2 className='text-[14px] font-bold mb-1'>BEST ONLINE SHOPPING SITE IN INDIA FOR FASHION</h2>
                        ...
                        <ol className='ps-10 mb-1'>
                            <li className='list-decimal my-1'>
                    ...
                    <div className='mb-5'>
                        <h2 className='text-[14px] font-bold mb-1'>AFFORDABLE FASHION AT YOUR FINGERTIPS</h2>
                        <p className='text-[15px]'>
                    ...
                    <div className='mb-5'>
                        <h2 className='text-[14px] font-bold mb-1'>MYNTRA INSIDER</h2>
                        <p className='text-[15px]'>
                    ...
                    <div className='mb-5'>
                        <h2 className='text-[14px] font-bold mb-1'>Myntra Studio - The Personalised Fashion Feed You Wouldn’t Want To Miss Out On</h2>
                        <p className='text-[15px] mb-1'>
                        ...
                        <ol className='ps-10 mb-1'>
                            <li className='list-decimal my-1'>
                                <b className='block'>Keep Up With What Your Favourite Fashion Icons Are Upto</b>
                                <p className='text-[15px] mb-1'>
                            ...
                            <li className='list-decimal my-1'>
                                <b className='block'>Quick Fashion Tip And Tricks</b>
                                <p className='text-[15px] mb-1'>
                            ...
                            <li className='list-decimal my-1'>
                                <b className='block'>Updates on What Is Trending and New Product Launches</b>
                                <p className='text-[15px] mb-1'>
                            ...
                            <li className='list-decimal my-1'>
                                <b className='block'>Explicit Step-By-Step Beauty Routines From Experts</b>
                                <p className='text-[15px] mb-1'>
                            ...
                            <li className='list-decimal my-1'>
                                <b className='block'>Celebrity Confessions And A Look Into Their Lives</b>
                                <p className='text-[15px] mb-1'>
                    ...
                    <div className='mb-5'>
                        <h2 className='text-[14px] font-bold mb-1'>MYNTRA APP</h2>
                        <p className='text-[15px]'>
                    ...
                    <div className='mb-5'>
                        <h2 className='text-[14px] font-bold mb-1'>HISTORY OF MYNTRA</h2>
                        <p className='text-[15px]'>
                    ...
                    <div className='mb-5'>
                        <h2 className='text-[14px] font-bold mb-1'>SHOP ONLINE AT MYNTRA WITH COMPLETE CONVENIENCE</h2>
                        <p className='text-[15px]'>
